	...
	function sim() {
		...
		switch(document.getElementById('kishu').options[document.getElementById('kishu').selectedIndex].value) {
			...
			case 'my5':
				...
				var p_cbig = [gousei2(1365.33,1820.45),gousei2(1365.33,1820.45),gousei2(1365.33,1820.45),gousei2(1365.33,1820.45),gousei2(1337.47,1820.45),gousei2(1129.93,1820.45)];
			...
			case 'funky2':
				...
				var p_cbig = [gousei2(1456.36,1724.64),gousei2(1365.33,1638.41),gousei2(1337.47,1560.39),gousei2(1337.47,1489.46),gousei2(1260.31,1365.34),gousei2(1191.56,1310.73)];
